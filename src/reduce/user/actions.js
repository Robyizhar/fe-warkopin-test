...
import { 
    ...
    SET_STATUS, SET_INPUT, SET_ROLE

} from './constants';

import { getData, saveData, detailData, editData } from '../../api/userAPI';
...
export const fetchData = () => {
    return  async (dispatch, getState) => {
        ...
        let perPage = getState().users.perPage || '';
        let currentPage = getState().users.currentPage || 1;
        let keyword = getState().users.keyword || '';
